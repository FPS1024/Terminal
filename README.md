...
| `out/Terminal_1.0.5_iphoneos-arm64.deb` | rootless 越狱安装包，安装至 `/var/jb/Applications` |
...
版本号可在命令行覆盖，例如 `make deb VERSION=1.0.5`。
...
```sh
make deb
# 把 out/Terminal_1.0.5_iphoneos-arm64.deb 传到设备后执行：
dpkg -i Terminal_1.0.5_iphoneos-arm64.deb
```
